...
* При генерации логина используется несуществующий домен что исключает дублирование с реальными почтовыми адресами. После входа в свой аккаунт пользователь может сменить сгенерированный логин на любой по своему усмотрению (пока реализовано только в панели адмиистратора).
